...
//esta classe será uma manipuladora de erros
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request){
		...
		for(FieldError x: e.getBindingResult().getFieldErrors()) { //dessa maneira é possível acessar todos os erros de campo que aconteceram
