...
public abstract class Pagamento implements Serializable{
	...
	@Id
	//aqui não vamos colcoar GeneratedValue, pois o ID do pagamento deverá ser o mesmo do Pedido correspondente
	private Integer id;
	...
	@MapsId //para garantir que o pedido do Pagamento seja o mesmo que o do Pedido
